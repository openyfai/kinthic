"""
Causal Knowledge Graph Generator — Epistemic Trajectory Tracing.
...
class EpistemicNode:
    ...
    def new(
        ...
        """Convenience constructor — auto-generates a UUID node_id."""
...
class CausalEdge:
    ...
    def new(
        ...
        """Convenience constructor — auto-generates a UUID edge_id."""
        return CausalEdge(
...
class CausalKnowledgeGraphGenerator:
    ...
    async def register_observation(
        ...
        This is the primary method cognitive_loop.py should call —
    ...
    async def query_traceback_tree(
        ...
        path — this prevents infinite loops even if the graph has cycles.
