...
SLASH_COMMANDS = [
    ...
    # ── World Model ──────────────────────────────────────────────────────
    {"cmd": "/graph",     "args": "[concept]",           "desc": "Show knowledge graph stats or concept neighborhood"},
    {"cmd": "/why",       "args": "<A> -> <B>",          "desc": "Show causal chain between two concepts"},
    ...
    {"cmd": "/debate",    "args": "<topic>",             "desc": "Run a multi-agent debate"},
    ...
    {"cmd": "/principles","args": "",                    "desc": "Show ethical principles"},
    ...
    # ── Routing ──────────────────────────────────────────────────────────
    {"cmd": "/model",     "args": "[provider]",          "desc": "Show or switch the active LLM provider"},
    {"cmd": "/mode",      "args": "speed|quality|auto",  "desc": "Set routing mode for this session"},
    {"cmd": "/providers", "args": "",                    "desc": "List all providers and API key status"},

    # ── RAG ──────────────────────────────────────────────────────────────
    {"cmd": "/index",     "args": "[path]",              "desc": "Index a folder into vector DB for RAG"},
