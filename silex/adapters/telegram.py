...
_active_loop: CognitiveLoop | None = None


def get_active_loop() -> "CognitiveLoop | None":
    return _active_loop
...
class TelegramAdapter(MessageAdapter):
    ...
    async def start_async(self, cognitive_loop: "CognitiveLoop") -> None:
...
async def _send_pending_approvals(update: "Update", loop: "CognitiveLoop") -> None:
