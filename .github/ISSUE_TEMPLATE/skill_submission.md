...
## 🛠 Skill Information
- **Skill Name**: `name_of_skill` (Must be snake_case, no spaces)
- **Description**: A short 1-line description of what this workflow does.
...
## 📄 Skill Code (`.md` format)

```markdown
# PASTE YOUR FULL SKILL MARKDOWN HERE
